...
3. Load `.specify/templates/spec-template.md` to understand required sections and `.github/prompts/architecture.prompt.md` for architectural context.
...
4. Follow this execution flow:
    ...
    7. Identify Key Entities (if data involved)
       - Consider domain entity patterns from architecture.prompt.md
       - Think about entity relationships, business rules, and state transitions
       - Entities should map to Clean Architecture domain layer
